      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <a 
            ...
            className="hidden sm:block px-6 py-2.5 rounded-full bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition-all active:scale-95"
          >
            M'embaucher
          </a>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10 animate-in fade-in slide-in-from-left duration-1000">
            ...
            <h1 className="text-6xl md:text-8xl font-black text-slate-900 leading-[0.9] tracking-tighter uppercase">
              DÉVELOPPER <br/>
              <span className="text-gradient italic">DEMAIN.</span>
            </h1>
            <p className="text-xl text-slate-500 max-w-xl leading-relaxed font-medium">
              {PERSONAL_INFO.bio}
            </p>
            <div className="flex gap-6">
              <a href={`mailto:${PERSONAL_INFO.email}`} className="px-8 py-4 rounded-2xl bg-blue-600 text-white font-black uppercase tracking-widest text-xs flex items-center gap-3 hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20">
                Me contacter <ArrowRight className="w-4 h-4" />
              </a>
              <div className="flex gap-4">
                <a href={`https://linkedin.com/in/${PERSONAL_INFO.linkedin}`} target="_blank" className="p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-500/40 text-slate-400 hover:text-blue-600 transition-all">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href={`https://github.com/${PERSONAL_INFO.github}`} target="_blank" className="p-4 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-500/40 text-slate-400 hover:text-blue-600 transition-all">
      ...
      <footer className="py-32 px-6 border-t border-slate-100 bg-slate-50/50">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center space-y-16">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href={`mailto:${PERSONAL_INFO.email}`} className="px-12 py-5 rounded-full bg-blue-600 text-white font-black uppercase tracking-widest text-xs shadow-2xl shadow-blue-500/20 hover:bg-blue-700 hover:scale-105 transition-all">
              Envoyer un Mail
            </a>
          ...
          <div className="pt-20 flex gap-12 text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">
            <a href={`https://linkedin.com/in/${PERSONAL_INFO.linkedin}`} className="hover:text-blue-600 transition-colors">Linkedin</a>
            <a href={`https://github.com/${PERSONAL_INFO.github}`} className="hover:text-blue-600 transition-colors">Github</a>
